...
string imagesFolderPath = "E:/SPRING 23-24/COMPUTER GRAPHICS/Computer-Graphics-main/OpenGL Programming/Resources/images/";
string soundsFolderPath = "E:/SPRING 23-24/COMPUTER GRAPHICS/Computer-Graphics-main/OpenGL Programming/Resources/sounds/";
...
void ciecle() {
    ...
    //MORE DEEPER COLORE CIRCLE IN FRONT
    glPushMatrix();
    glTranslatef(0, -10, 0);
    glScalef(1, 1.8, 1);
    glBegin(GL_POLYGON); // Draw a Red Half Circle centered at origin
    ...
    //NOW PRINTING THE FRONT CIECLE, TRANSLATING THE FIRST ONE IN Y AXIS
    ...
    //DEEPER LINE AT THE BACK TO ACCURATE THE DESIGN
    glLineWidth(7.5);
    glBegin(GL_LINES);
    glColor3f(0.19, 0.26, 0.19);
...
int main(int argc, char** argv) {
    ...
    glutTimerFunc(10, update, 0); // ID - 69  //RAIN
    glutTimerFunc(20, move_flying_car, 0); // ID - 70
