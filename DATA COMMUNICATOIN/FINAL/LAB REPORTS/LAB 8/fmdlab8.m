...
Am1 = 3; %Amplitude of First Message Signal
fm1 = 10; %Frequency of First Message Signal
m1 = Am1*cos(2*pi*fm1*t); % First Message Signal

Am2 = 6; %Amplitude of Second Message Signal
fm2 = 11; %Frequency of Second Message Signal
m2 = Am2*cos(2*pi*fm2*t); % Second Message Signal

Am3 = 9; %Amplitude of Third Message Signal
fm3 = 12; %Frequency of Third Message Signal
m3 = Am3*cos(2*pi*fm3*t); % Third Message Signal

Am4 = 12; %Amplitude of Fourth Message Signal
fm4 = 13; %Frequency of Fourth Message Signal
...
fc2 = 100; %Frequency of Second Carrier Signal
